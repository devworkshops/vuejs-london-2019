<template>
    <div>
        ...
        <form @submit.prevent="save()">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input
                        ...
                        :class="{
                            'is-invalid': $v.product.unitsInStock.$error
                        }"
                    />
                    <div
                        class="invalid-feedback"
                ...
                <div class="form-group col-md-4">
                    ...
                    <input
                        ...
                        :class="{
                            'is-invalid': $v.product.unitsOnOrder.$error
                        }"
                    />
                    <div
                        class="invalid-feedback"
                    ...
                    >
                        Stock has run out! Units on order must be greater than
                        zero.
                    </div>
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-4">
                    ...
                    <input
                        ...
                        :class="{
                            'is-invalid': $v.product.reorderLevel.$error
                        }"
                    />
                    <div
                        class="invalid-feedback"
            ...
            <button @click="navigateBack()" class="btn btn-default">
                Cancel
            </button>
        </form>
    </div>
